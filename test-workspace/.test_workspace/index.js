...
var f$1 = _descriptors ? Object.defineProperty : function (O, P, Attributes) {
  _anObject(O);
...
var _enumBugKeys = ['constructor', 'hasOwnProperty', 'isPrototypeOf', 'propertyIsEnumerable', 'toLocaleString', 'toString', 'valueOf'];

// 19.1.2.7 / 15.2.3.4 Object.getOwnPropertyNames(O)
var hiddenKeys = _enumBugKeys.concat('length', 'prototype');

var f$2 = Object.getOwnPropertyNames || function (O) {
...
var _arrayFill = function (value /*, start = 0, end = @length */) {
...
// 7.2.9 SameValue(x, y)
var _sameValue = Object.is || function (x, y) {
...
var _objectDps = _descriptors ? Object.defineProperties : function (O, Properties) {
  _anObject(O);
...
var _objectCreate = Object.create || function (O, Properties) {
  var result;
  if (O !== null) {
...
var _arrayMethods = function (TYPE, $create) {
  ...
  return function ($this, callbackfn, that) {
    var O = _toObject($this),
        ...
        index = 0,
        result = IS_MAP ? create($this, length) : TYPE == 2 ? create($this, 0) : undefined,
        val,
        res;
    ...
    }return IS_FIND_INDEX ? -1 : TYPE == 3 || IS_EVERY ? IS_EVERY : result;
  };
};
...
var _arrayCopyWithin = [].copyWithin || function (target /*= 0*/, start /*= 0, end = @length*/) {
  var O = _toObject(this),
...
var f$3 = _descriptors ? gOPD : function (O, P) {
  O = _toIobject(O);
  P = _toPrimitive(P, true);
  if (_ie8DomDefine) try {
    return gOPD(O, P);
...
if (_descriptors) {
  var LIBRARY = _library,
      ...
      isObject = _isObject,
      toObject = _toObject,
      isArrayIter$$1 = _isArrayIter,
      create = _objectCreate,
      getPrototypeOf$$1 = _objectGpo,
      gOPN = _objectGopn.f,
      getIterFn$$1 = core_getIteratorMethod,
      uid = _uid,
      wks = _wks,
  ...
  var strictToLength = function (it, SAME) {
    ...
    if (SAME && !same(+it, length)) throw RangeError(WRONG_LENGTH);
    return length;
  };
  ...
  var $from = function (source /*, mapfn, thisArg */) {
    var O = toObject(source),
        aLen = arguments.length,
        mapfn = aLen > 1 ? arguments[1] : undefined,
        mapping = mapfn !== undefined,
        iterFn = getIterFn$$1(O),
        i,
        length,
        values,
        result,
  ...
  var $set = function (arrayLike /*, offset */) {
    validate(this);
  ...
  var $getDesc = function (target, key) {
    return isTAIndex(target, key = toPrimitive(key, true)) ? propertyDesc(2, target[key]) : gOPD(target, key);
  };
  var $setDesc = function (target, key, desc) {
  ...
  module.exports = function (KEY, BYTES, wrapper, CLAMPED) {
    ...
    if (FORCED) {
      ...
      TypedArray = wrapper(function (that, data, $offset, $length) {
        ...
        if (!isObject(data)) return new Base(strictToLength(data, NAME != 'Uint8Array'));
...
var _bind = Function.bind || function (that /*, args... */) {
...
var _ownKeys = Reflect$1 && Reflect$1.ownKeys || function (it) {
...
var isSymbol = USE_NATIVE$1 && _typeof$1($Symbol.iterator) == 'symbol' ? function (it) {
  return (typeof it === 'undefined' ? 'undefined' : _typeof$1(it)) == 'symbol';
} : function (it) {
  return it instanceof $Symbol;
};

var $defineProperty$1 = function (it, key, D) {
...
for (var symbols = ['hasInstance', 'isConcatSpreadable', 'iterator', 'match', 'replace', 'search', 'species', 'split', 'toPrimitive', 'toStringTag', 'unscopables'], i$1 = 0; symbols.length > i$1;) {
  _wks(symbols[i$1++]);
...
NAME in FProto || _descriptors && dP$3(FProto, NAME, {
  ...
  get: function get() {
    try {
      ...
      _has(that, NAME) || !isExtensible(that) || dP$3(that, NAME, _propertyDesc(5, name));
      return name;
    } catch (e) {
      return '';
    }
...
var _stringRepeat = function (count) {
...
var _mathLog1p = Math.log1p || function (x) {
...
var _mathSign = Math.sign || function (x) {
...
_export(_export.S, 'Object', {
  getOwnPropertyDescriptors: function (object) {
    var O = _toIobject(object),
        ...
        key;
    while (keys.length > i) {
      _createProperty(result, key = keys[i++], getDesc(O, key));
    }return result;
  }
});
...
var wrap$1 = function (set) {
  return MSIE ? function (fn, time /*, ...args */) {
    return set(_invoke(_partial, [].slice.call(arguments, 2), typeof fn == 'function' ? fn : Function(fn)), time);
  } : set;
};
